...
*
* \funcusage
*  \snippet LEFT_RIGHT_SUT.c usage_LEFT_RIGHT_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LEFT_RIGHT_SUT.c usage_LEFT_RIGHT_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LEFT_RIGHT_SUT.c usage_LEFT_RIGHT_Read  
*******************************************************************************/
...
* preferred LEFT_RIGHT_Read() API because the 
* LEFT_RIGHT_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LEFT_RIGHT_SUT.c usage_LEFT_RIGHT_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: LEFT_RIGHT_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use LEFT_RIGHT_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - LEFT_RIGHT_0_INTR       (First pin in the list)
    *  - LEFT_RIGHT_1_INTR       (Second pin in the list)
    *  - ...
    *  - LEFT_RIGHT_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet LEFT_RIGHT_SUT.c usage_LEFT_RIGHT_SetInterruptMode
    *******************************************************************************/
    void LEFT_RIGHT_SetInterruptMode(uint16 position, uint16 mode) 
                            
    {
		if((position & LEFT_RIGHT_0_INTR) != 0u) 
		{ 
			 LEFT_RIGHT_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet LEFT_RIGHT_SUT.c usage_LEFT_RIGHT_ClearInterrupt
    *******************************************************************************/
