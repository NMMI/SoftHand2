...
#endif /* defined(ADC_1_theACLK__CFG3) */

#define ADC_1_theACLK_Enable()                       ADC_1_theACLK_Start()
#define ADC_1_theACLK_Disable()                      ADC_1_theACLK_Stop()
#define ADC_1_theACLK_SetDivider(clkDivider)         ADC_1_theACLK_SetDividerRegister(clkDivider, 1u)
#define ADC_1_theACLK_SetDividerValue(clkDivider)    ADC_1_theACLK_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define ADC_1_theACLK_SetPhaseValue(clkPhase)        ADC_1_theACLK_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(ADC_1_theACLK__CFG3) */
