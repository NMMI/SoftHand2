...
{
    CY_SET_REG24(SHIFTREG_ENC_2_SHIFT_REG_LSB_PTR, shiftData);
}
    ...
    *******************************************************************************/
    ...
    {
        return(CY_GET_REG24(SHIFTREG_ENC_2_OUT_FIFO_VAL_LSB_PTR));
    }
...
uint32 SHIFTREG_ENC_2_ReadRegValue(void) 
{
    ...
    {
        (void) CY_GET_REG24(SHIFTREG_ENC_2_OUT_FIFO_VAL_LSB_PTR);
    }
    ...
    /* Read output FIFO */
    result  = CY_GET_REG24(SHIFTREG_ENC_2_OUT_FIFO_VAL_LSB_PTR);
