 ...
 *************************************/
    ...
    #define WATCHDOG_COUNTER_AUX_CONTROLDP0_PTR \
       ...
       #define WATCHDOG_COUNTER_AUX_CONTROLDP1 \
           (*(reg8 *) WATCHDOG_COUNTER_CounterUDB_sC8_counterdp_u1__DP_AUX_CTL_REG)
       #define WATCHDOG_COUNTER_AUX_CONTROLDP1_PTR \
           ( (reg8 *) WATCHDOG_COUNTER_CounterUDB_sC8_counterdp_u1__DP_AUX_CTL_REG)
    #endif /* (WATCHDOG_COUNTER_Resolution == 16 || WATCHDOG_COUNTER_Resolution == 24 || WATCHDOG_COUNTER_Resolution == 32) */
    
    #if (WATCHDOG_COUNTER_Resolution == 24 || WATCHDOG_COUNTER_Resolution == 32)
       #define WATCHDOG_COUNTER_AUX_CONTROLDP2 \
           (*(reg8 *) WATCHDOG_COUNTER_CounterUDB_sC8_counterdp_u2__DP_AUX_CTL_REG)
       #define WATCHDOG_COUNTER_AUX_CONTROLDP2_PTR \
           ( (reg8 *) WATCHDOG_COUNTER_CounterUDB_sC8_counterdp_u2__DP_AUX_CTL_REG)
    #endif /* (WATCHDOG_COUNTER_Resolution == 24 || WATCHDOG_COUNTER_Resolution == 32) */
    
    #if (WATCHDOG_COUNTER_Resolution == 32)
       #define WATCHDOG_COUNTER_AUX_CONTROLDP3 \
           (*(reg8 *) WATCHDOG_COUNTER_CounterUDB_sC8_counterdp_u3__DP_AUX_CTL_REG)
       #define WATCHDOG_COUNTER_AUX_CONTROLDP3_PTR \
           ( (reg8 *) WATCHDOG_COUNTER_CounterUDB_sC8_counterdp_u3__DP_AUX_CTL_REG)
    #endif /* (WATCHDOG_COUNTER_Resolution == 32) */

#endif  /* (WATCHDOG_COUNTER_UsingFixedFunction) */

#if (WATCHDOG_COUNTER_UsingFixedFunction)
    #define WATCHDOG_COUNTER_STATUS         (*(reg8 *) WATCHDOG_COUNTER_CounterHW__SR0 )
    /* In Fixed Function Block Status and Mask are the same register */
    #define WATCHDOG_COUNTER_STATUS_MASK             (*(reg8 *) WATCHDOG_COUNTER_CounterHW__SR0 )
    #define WATCHDOG_COUNTER_STATUS_MASK_PTR         ( (reg8 *) WATCHDOG_COUNTER_CounterHW__SR0 )
    #define WATCHDOG_COUNTER_CONTROL                 (*(reg8 *) WATCHDOG_COUNTER_CounterHW__CFG0)
    #define WATCHDOG_COUNTER_CONTROL_PTR             ( (reg8 *) WATCHDOG_COUNTER_CounterHW__CFG0)
    #define WATCHDOG_COUNTER_CONTROL2                (*(reg8 *) WATCHDOG_COUNTER_CounterHW__CFG1)
    #define WATCHDOG_COUNTER_CONTROL2_PTR            ( (reg8 *) WATCHDOG_COUNTER_CounterHW__CFG1)
    #if (CY_PSOC3 || CY_PSOC5LP)
        #define WATCHDOG_COUNTER_CONTROL3       (*(reg8 *) WATCHDOG_COUNTER_CounterHW__CFG2)
        #define WATCHDOG_COUNTER_CONTROL3_PTR   ( (reg8 *) WATCHDOG_COUNTER_CounterHW__CFG2)
    #endif /* (CY_PSOC3 || CY_PSOC5LP) */
    #define WATCHDOG_COUNTER_GLOBAL_ENABLE           (*(reg8 *) WATCHDOG_COUNTER_CounterHW__PM_ACT_CFG)
    #define WATCHDOG_COUNTER_GLOBAL_ENABLE_PTR       ( (reg8 *) WATCHDOG_COUNTER_CounterHW__PM_ACT_CFG)
    #define WATCHDOG_COUNTER_GLOBAL_STBY_ENABLE      (*(reg8 *) WATCHDOG_COUNTER_CounterHW__PM_STBY_CFG)
    #define WATCHDOG_COUNTER_GLOBAL_STBY_ENABLE_PTR  ( (reg8 *) WATCHDOG_COUNTER_CounterHW__PM_STBY_CFG)
    ...
    ********************************/
    ...
    #define WATCHDOG_COUNTER_BLOCK_EN_MASK          WATCHDOG_COUNTER_CounterHW__PM_ACT_MSK
    #define WATCHDOG_COUNTER_BLOCK_STBY_EN_MASK     WATCHDOG_COUNTER_CounterHW__PM_STBY_MSK 
    
    /* Control Register Bit Locations */    
    /* As defined in Register Map, part of TMRX_CFG0 register */
    #define WATCHDOG_COUNTER_CTRL_ENABLE_SHIFT      0x00u
    #define WATCHDOG_COUNTER_ONESHOT_SHIFT          0x02u
    /* Control Register Bit Masks */
    #define WATCHDOG_COUNTER_CTRL_ENABLE            ((uint8)((uint8)0x01u << WATCHDOG_COUNTER_CTRL_ENABLE_SHIFT))         
    #define WATCHDOG_COUNTER_ONESHOT                ((uint8)((uint8)0x01u << WATCHDOG_COUNTER_ONESHOT_SHIFT))

    /* Control2 Register Bit Masks */
    /* Set the mask for run mode */
    #if (CY_PSOC5A)
        /* Use CFG1 Mode bits to set run mode */
        #define WATCHDOG_COUNTER_CTRL_MODE_SHIFT        0x01u    
        #define WATCHDOG_COUNTER_CTRL_MODE_MASK         ((uint8)((uint8)0x07u << WATCHDOG_COUNTER_CTRL_MODE_SHIFT))
    #endif /* (CY_PSOC5A) */
    #if (CY_PSOC3 || CY_PSOC5LP)
        /* Use CFG2 Mode bits to set run mode */
        #define WATCHDOG_COUNTER_CTRL_MODE_SHIFT        0x00u    
